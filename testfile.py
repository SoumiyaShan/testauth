...
__name__ = "SemanticsWorkLoads" # bag of words workloads
__module__ = "property"
__package__ = "markets"
__app__ = "mining"
...
#         self._portfolio=None
    ...
    def get_rooms_data(
        ...
        **kwargs):
        ...
        __s_fn_id__ = f"{self.__name__} function <get_rooms_data>"
    ...
    def save_rooms_data(
        ...
        **kwargs):
        ...
        __s_fn_id__ = f"{self.__name__} function <save_data>"
        ...
        try:
            ...
            if self._data is None or self._data.count() <= 0:
                raise RuntimeError("retuned an empty %s bow dict",
                                   type(self._data))
            logger.debug("%s saved with %d rows",__s_fn_id__,len(self._bow))
